...
public class SetupPage extends AbstractPage {
	...
	public void findSetupElement(String element) throws Exception {
		...
		waitForElementVisible(By.xpath("//a[text()='" + element + "']"),
				PAUSE_LENGTH.AVG);

		driver.findElement(By.xpath("//a[text()='" + element + "']")).click();
	}

	public void enableActionsInThePublisher() throws Exception {
		...
		if (!("true").equals(enableActionsInThePublisher
