...
public class CopyingApplicationDataToTalentProfile extends BaseTestCase {
	...
	@Test(priority = 0)
	public void copyingApplicationDataToTalentProfile() throws Throwable {
		try {
			loginPage.login();
			setupPage.findSetupElement("Process Builder");
			createFlowPage.createCopyingApplicationDataToTalentProfileFlow(
					"Auto Copying Application Data to Talent Profile",
					"Copying Application Data to Talent Profile", "Application",
